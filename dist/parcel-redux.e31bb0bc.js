...
var btnDecrease = document.querySelector('#Decrease'); //액션타입 만들어놓기
...
}; //increase 호출할때 함수처럼쓰고 difference를변서처럼 사용능합니다.
  ...
  switch (action.type) {
    case TOGGLE_SWITCH:
      return _objectSpread(_objectSpread({}, state), {}, {
        //불변성 유지 때문이라고 합니다.  state값을 미리 전개해줘서 값을 넘겨줍니다.  ... 은 전개의 표현입니다.
        toggle: !state.toggle
      });
...
render(); //스토어 구독하기  스토어 구독해놓아서  스토어 바뀌면 렌더를 다시해줌  일단은지 직접 subscribe 하지만 완성형이 아님.

store.subscribe(render); //이거 없어도 실행됨 구독 등록해놓으면 계속띄워주려는 의도같음 구독 비활성화도있다고함 참고
...
},{"redux":"node_modules/redux/es/redux.js"}],"../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/parcel-redux.e31bb0bc.js.map